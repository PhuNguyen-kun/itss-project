...
exports.addToFridge = asyncHandler(async (req, res) => {
    ...
    const fridge = await fridgeService.addToFridge({
        family_id,
        ingredient_id,
        quantity,
        unit,
    ...
    return responseOk(
        res,
        fridge,
        "Ingredient added to fridge successfully",
        200
    );
});
...
exports.deleteFromFridge = asyncHandler(async (req, res) => {
    ...
    const deletedCount = await fridgeService.deleteFromFridge({
        family_id,
        ingredient_id,
        unit,
    });
    ...
    return responseOk(
        ...
        "Ingredient removed from fridge successfully",
        200
    );
});
 ...
 */
exports.getFamilyFridgeItems = asyncHandler(async (req, res) => {
    ...
    const fridgeItems = await fridgeService.getFamilyFridgeItems(familyId);

    return responseOk(
        res,
        fridgeItems,
        "Family fridge items retrieved successfully"
    );
});
